...
(function() {
  ...
  function brandLogo(height = 44) {
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 100" width="${w}" height="${height}" fill="none" aria-hidden="true">
      ...
      <!-- ACCS logotype -->
      <text x="100" y="58" font-family="'DM Serif Display',Georgia,serif" font-size="38" font-weight="400" fill="currentColor" letter-spacing="3">ACCS</text>
      <!-- Tagline -->
      <text x="101" y="74" font-family="'Plus Jakarta Sans',system-ui,sans-serif" font-size="11" font-weight="500" fill="currentColor" opacity="0.6" letter-spacing="1.5">CARE SERVICES</text>
    </svg>`;
  }
